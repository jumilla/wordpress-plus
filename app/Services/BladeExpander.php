...
//			        	debug_log("[[directive]]", $directive);
     ...
     * @return null
     */
    protected /* override */ function compileExtends($expression)
    {
     ...
     * @return null
     */
    protected /* override */ function compileInclude($expression)
    {
     ...
     * @return null
     */
    protected /* override */ function compileEach($expression)
    {
     ...
     * @return string
     */
    protected /* override */ function compileSection($expression)
    {
     ...
     * @return null
     */
    protected /* override */ function compileEndsection($expression)
    {
     ...
     * @return null
     */
    protected /* override */ function compileStop($expression)
    {
     ...
     * @return null
     */
    protected /* override */ function compileOverwrite($expression)
    {
     ...
     * @return null
     */
    protected /* override */ function compileAppend($expression)
    {
     ...
     * @return string
     */
    protected /* override */ function compileShow($expression)
    {
     ...
     * @return string
     */
    protected /* override */ function compileYield($expression)
    {
     ...
     * @return null
     */
    protected /* override */ function compilePush($expression)
    {
     ...
     * @return null
     */
    protected /* override */ function compileEndpush($expression)
    {
     ...
     * @return string
     */
    protected /* override */ function compileStack($expression)
    {
   ...
   /**
     ...
     * @return string
     */
    public /* override */ function getCompiledPath($path)
    {
        return $path;
    }
     ...
     * @return bool
     */
    public /* override */ function isExpired($path)
    {
    	return false;
    }
     ...
     * @return null
     */
    public /* override */ function compile($path = null)
    {
    	// nothing todo
    }
